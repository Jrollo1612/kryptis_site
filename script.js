...
const I18N = {
  ...
  fr: {
    ...
    "reviews.p": "Aidez les autres en partageant votre avis sur Traducteur Morse ⭐",
    ...
    "reviews.byline": "Par",
    "reviews.on": "le",
    "thanks.pageTitle": "Merci - Traducteur Morse",
    "thanks.metaDescription": "Merci pour votre avis sur Traducteur Morse !",
    "thanks.metaKeywords": "traducteur morse merci, confirmation avis, retour",
    "thanks.title": "Merci aux acteurs qui m'ont aidé à créer ce projet !",
    "thanks.message": "Merci principalement au groupe scout où j'ai appris le code Morse et où j'ai commencé ce projet de traducteur Morse.",
    ...
    "whoami.pageTitle": "Qui suis-je - Traducteur Morse",
    "whoami.metaDescription": "Découvrez le créateur de Traducteur Morse, Joseph Rollo, et sa passion pour le code Morse et le développement logiciel.",
    "whoami.metaKeywords": "Joseph Rollo, créateur Traducteur Morse, développeur logiciel, passionné de code Morse, à propos de l'auteur",
    "whoami.title": "À propos de l'auteur",
    "whoami.description": "Joseph Rollo est un développeur logiciel passionné et un amateur de code Morse. Avec une formation en informatique, il a créé Traducteur Morse pour partager son amour du code Morse et offrir un outil utile aux autres. Lorsqu'il ne code pas, Joseph aime explorer de nouvelles technologies et contribuer à l'open source.",
  ...
  es: {
    ...
    "reviews.p": "Ayuda a otros compartiendo tu opinión sobre Morse Translator ⭐",
    ...
    "reviews.byline": "Por",
    "reviews.on": "el",
    "thanks.pageTitle": "Gracias - Morse Translator",
    "thanks.metaDescription": "¡Gracias por tu opinión sobre Morse Translator!",
    "thanks.metaKeywords": "morse translator gracias, confirmación de reseña, feedback",
    "thanks.title": "¡Gracias a los actores que me ayudaron a crear este proyecto!",
    "thanks.message": "Gracias principalmente al grupo scout donde aprendí el código Morse y donde comencé este proyecto del traductor Morse.",
    ...
    "whoami.pageTitle": "Quién soy - Morse Translator",
    "whoami.metaDescription": "Conoce al creador de Morse Translator, Joseph Rollo, y su pasión por el código Morse y el desarrollo de software.",
    "whoami.metaKeywords": "Joseph Rollo, creador de Morse Translator, desarrollador de software, entusiasta del código Morse, sobre el autor",
    "whoami.title": "Sobre el autor",
    "whoami.description": "Joseph Rollo es un apasionado desarrollador de software y entusiasta del código Morse. Con una formación en informática, creó Morse Translator para compartir su amor por el código Morse y ofrecer una herramienta útil a los demás. Cuando no está programando, a Joseph le gusta explorar nuevas tecnologías y contribuir a proyectos de código abierto.",
